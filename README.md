...
# :page_facing_up: Web Application Template - Baseline Model
...
### :globe_with_meridians: Install Global Packages
...
## :checkered_flag: Build Instructions
...
### :globe_with_meridians: Web Server Configuration
...
#### Processing HTML from PUG files
